...
problem.bounds = col.Bounds(optimal_control_problem=problem, initial_time=0.0, final_time=[tfmin, tfmax], state=[[xmin, xmax], [ymin, ymax], [vmin, vmax]], control=[umin, umax], state_endpoint_lower=[x0, y0, v0, xf, yf, vmin], state_endpoint_upper=[x0, y0, v0, xf, yf, vmax])
