...
u_x : Cartesian x-vector inertial trust (N)
u_y : Cartesian y-vector inertial trust (N)
u_z : Cartesian z-vector inertial trust (N)
...
m_t0 = (9 * m_tot_S) + m_tot_1 + m_tot_2 + m_payload
m_upper_bnd = m_t0
m_lower_bnd = m_t0 - (6 * m_prop_S) + (tau_burn_S * m_prop_1 / tau_burn_1)
