...
mesh = pycollo.Mesh(mesh_sections=2, mesh_section_fractions=None, mesh_collocation_points=4)
...
# Guess
problem.initial_guess = pycollo.Guess(optimal_control_problem=problem, time=[0, 1],
