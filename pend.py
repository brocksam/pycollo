...
mesh = col.Mesh(mesh_sections=3, mesh_section_fractions=None, mesh_collocation_points=5)
...
# Bounds
problem.bounds = col.Bounds(initial_time_lower=0.0, initial_time_upper=0.0, final_time_lower=1.0, final_time_upper=1.0, state=[['-inf', 'inf'], ['-inf', 'inf']], control_lower='-inf', control_upper='inf', integral_lower=[0], integral_upper=['inf'], boundary_lower=[0, 0, np.pi, 0], boundary_upper=[0, 0, np.pi, 0])
